...
<!-------------------- Favourite Movies  ----------------------------------------------->
		<a href="favourite.php"><button id="favTab"class="topBtn" ><span>Favourite Movies</span></button></a>
...
<!-------------------- Sorting denemesi END ----------------------------------------------->
			...
			<tr>
				...
				if(isset($_POST["sortingMenu"])){
					$s=$_POST['sortingMenu'];
				}
				$stmt=$pdo->query("SELECT * FROM movies ORDER BY $s");	
